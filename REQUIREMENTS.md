...
| R 4.2 | При наведении на виджет, появляется выпадающее меню, содержащее следующие общие пункты: <ul><li>`Профиль`: ссылка на профиль пользователя</li><li>`Настройки`: ссылка на страницу настроек аккаунта</li><li>`Выйти`: кнопка для выхода из учётной записи</li></ul> | |
| R 4.2.1 | При нажатии на пункт меню, происходит переход на соответствующую страницу | |
| R 4.2.2 | При нажатии на пункт `Выйти` происходит выход из учётной записи и перенаправление на страницу `logout` | |
